! function(e, t) {
    ...
    var p = function(n) {
        var e, h, _, o, r, p, f, g, w, l, u, E, x, s, T, m, a, c, v, C = "sizzle" + 1 * new Date,
            y = n.document,
            S = 0,
            i = 0,
            d = le(),
        ...
        for (e in h = ae.support = {}, r = ae.isXML = function(e) {
                ...
                var n = _.attrHandle[t.toLowerCase()],
                    i = n && k.call(_.attrHandle, t.toLowerCase()) ? n(e, t, !T) : void 0;
...
function(e, t) {
    ...
    var Le = Te && !(!window.MSInputMethodContext || !document.documentMode),
        je = Te && /MSIE 10/.test(navigator.userAgent);
                ...
                computeStyle: {
                    ...
                    fn: function(e, t) {
                        ...
                        var s, a, l, u, c, f, d, h, p, g, m, v, y, b, _ = void 0 !== o ? o : t.gpuAcceleration,
                            ...
                            T = (s = e, a = window.devicePixelRatio < 2 || !ft, l = s.offsets, u = l.popper, c = l.reference, f = Math.round, d = Math.floor, h = function(e) {
                                return e
                            ...
                            D = void 0,
                            N = void 0;
                        if (N = "bottom" === C ? "HTML" === w.nodeName ? -w.clientHeight + T.bottom : -E.height + T.bottom : T.top, D = "right" === S ? "HTML" === w.nodeName ? -w.clientWidth + T.right : -E.width + T.right : T.left, _ && A) x[A] = "translate3d(" + D + "px, " + N + "px, 0)", x[C] = 0, x[S] = 0, x.willChange = "transform";
                        else {
                            var k = "bottom" === C ? -1 : 1,
                                I = "right" === S ? -1 : 1;
    ...
    var Et = "dropdown",
        ...
        Dt = {
            ...
            SHOWN: "shown" + Tt,
            CLICK: "click" + Tt,
            CLICK_DATA_API: "click" + Tt + Ct,
            KEYDOWN_DATA_API: "keydown" + Tt + Ct,
            KEYUP_DATA_API: "keyup" + Tt + Ct
        },
        Nt = "disabled",
        kt = "show",
        It = "dropup",
    ...
    p.fn[Fi] = Zi._jQueryInterface, p.fn[Fi].Constructor = Zi, p.fn[Fi].noConflict = function() {
        ...
        }(), e.Util = g, e.Alert = m, e.Button = I, e.Carousel = ae, e.Collapse = xe, e.Dropdown = Yt, e.Modal = mn, e.Popover = ii, e.Scrollspy = xi, e.Tab = Wi, e.Toast = Zi, e.Tooltip = Un, Object.defineProperty(e, "__esModule", {
            value: !0
        })
}),
function(D) {
