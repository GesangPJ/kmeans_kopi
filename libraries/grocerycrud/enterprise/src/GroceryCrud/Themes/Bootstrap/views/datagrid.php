<?php
    ...
    $this->setCssFile($this->_assetsFolder.'css/grocery-crud-v2.7.11.d4fc1a0.css');
    ...
    $this->setJavaScriptFile($this->_assetsFolder . 'js/build/grocery-crud-v2.7.11.d4fc1a0' . $minify_or_not . '.js');
